...
var birthday = new Date(1974, 10, 18);

function getVillainName(birthday) {
    var monthDate = ["The Evil", "The Vile", "The Cruel", "The Trashy", "The Despicable", "The Embarrassing", "The Disreputable", "The Atrocious", "The Twirling",
        "The Orange", "The Terrifying", "The Awkward"];

    var digitDate = ["Mustache", "Pickle", "Hood Ornament", "Raisin", "Recycling Bin", "Potato", "Tomato", "House Cat",
        "Teaspoon", "Laundry Basket"];
    var myMonth = monthDate[birthday.getMonth()];
    var myDay = digitDate[birthday.getDate() % 10];
