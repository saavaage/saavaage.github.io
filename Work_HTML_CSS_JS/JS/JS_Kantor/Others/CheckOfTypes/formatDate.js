...
/*
 ...
 3. Как число секунд с 01 - Start.01 - Start.1970.
...
console.log(formatDate([2014, 0, 1])); // 01 - Start.01 - Start.14
console.log(formatDate(new Date(2014, 0, 1))); // 01 - Start.01 - Start.14
