...
/*
 ...
 3. Как число секунд с 01 - BASE.01 - BASE.1970.
...
console.log(formatDate([2014, 0, 1])); // 01 - BASE.01 - BASE.14
console.log(formatDate(new Date(2014, 0, 1))); // 01 - BASE.01 - BASE.14
